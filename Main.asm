...
CommMenu proc far
    ...
    InValidCommand:
        ...
        ; 5ra l stack bydrb fa mby3ml4 return s7
        cmp ah, EnterScanCode
        jz CONT_INVALID
        cmp ah, RightScanCode
...
ourGetSrcOp PROC    ; Returned Value is saved in AX
    ...
    CMP selectedOp2Type, 3
    JZ SrcOp2Vala
    JMP InValidCommand_OurGetSrcOp
